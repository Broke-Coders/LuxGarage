...
public class VehicleStatus
{
    ...
    /// <summary>Gets or sets the date and time when this status became active.</summary>
    public required DateTime StartingDate { get; set; } = DateTime.Now;

    /// <summary>Gets or sets the optional date and time when this status ceased to be active.</summary>
